...
![5 frontier models and 410 coding-agent runs: a 14x cost difference for identical outcomes, 100 percent solved when the model could run the tests, and 40 percent of requests refused by one model's safety layer](charts/hero.png)
